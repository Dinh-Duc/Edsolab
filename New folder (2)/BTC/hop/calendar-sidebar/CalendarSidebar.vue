    ...
    >
      <div class="sidebar-wrapper__calander">
        ...
        <div class="sidebar-calander__filter">
          ...
          <div class="mt-2">
            <h5 class="app-label">
              <span class="align-middle mr-auto">Phòng họp trực tuyến</span>
            </h5>
            <div
...
export default {
  ...
  data() {
    return {
      ...
      filterUnitEvent: [
        {
          tenDonVi: 'Vụ Địa chất',
          id: 'hdtv_1',
          count: '1'
        },
        {
          tenDonVi: 'Vụ Khoáng sản',
          id: 'hdtv_2',
          count: '1'
        },
        {
          tenDonVi: 'Vụ Chính sách và Pháp chế',
          id: 'hdtv_3',
          count: '1'
        },
        {
          tenDonVi: 'Vụ Khoa học, Công nghệ và Hợp tác quốc tế',
          id: 'hdtv_4',
          count: '1'
        },
        {
          tenDonVi: 'Vụ Kế hoạch - Tài chính',
          id: 'hdtv_5',
          count: '1'
        },
        {
          tenDonVi: 'Vụ Tổ chức cán bộ',
          id: 'hdtv_6',
          count: '1'
        },
        {
          tenDonVi: 'Văn phòng Tổng cục',
          id: 'hdtv_7',
          count: '1'
        },
        {
          tenDonVi: 'Cục Kinh tế Địa chất và Khoáng sản',
          id: 'hdtv_8',
          count: '1'
        },
        {
          tenDonVi: 'Cục Kiểm soát hoạt động khoáng sản miền Bắc',
          id: 'hdtv_9',
          count: '1'
        },
        {
          tenDonVi: 'Cục Kiểm soát hoạt động khoáng sản miền Trung',
          id: 'hdtv_10',
          count: '1'
        },
        {
          tenDonVi: 'Cục Kiểm soát hoạt động khoáng sản miền Nam',
          id: 'hdtv_11',
          count: '1'
        }
      ],
      sidebarHopTrucTuyen: [
        {
          name: 'Phòng họp Lãnh đạo Tổng cục',
          id: 'type_1',
          count: '1',
          link:
        ...
        {
          name: 'Phòng họp giao ban Tổng cục',
          id: 'type_2',
          count: '1',
          link:
        ...
        {
          name: 'Phòng họp Đảng ủy Tổng cục',
          id: 'type_3',
          count: '1',
          link:
