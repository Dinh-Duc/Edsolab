<template>
  ...
  <div style="height: inherit">
    ...
    <section class="chat-app-window">
      ...
      <div
        v-else-if="checkopenSideBar === 'settings'"
        class="active-chat chat-video-box"
      >
        <MeetingSettings />
      </div>

      <div
        v-else-if="checkopenSideBar === 'videocall'"
        class="active-chat chat-video-box"
      >
        <Meeting />
      </div>
...
export default {
  components: {
    ...
    MeetingSettings: () => import('./MeetingSettings.vue'),
  ...
  setup() {
    ...
    const checkopenSideBar = ref('null')

    const openSideBar = item => {
      console.log('item: ', item)
      checkopenSideBar.value = item
    }
