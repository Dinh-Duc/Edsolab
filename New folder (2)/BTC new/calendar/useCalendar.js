...
export default function userCalendar() {
  ...
  const calendarOptions = ref({
    ...
    */
    ...
    // eventContent({ event: data, view }) {
    //   if (view.type.includes('list')) {
    //     const title = document.createElement('div')
    //     title.innerHTML = data.title

    //     const desc = document.createElement('div')
    //     if (data.extendedProps.description) {
    //       desc.innerHTML = data.extendedProps.description
    //     }

    //     const user = document.createElement('div')
    //     if (data.extendedProps.user) {
    //       user.innerHTML = data.extendedProps.user
    //     }

    //     const address = document.createElement('div')
    //     if (data.extendedProps.address) {
    //       address.innerHTML = data.extendedProps.address
    //     }

    //     const arrayOfDomNodes = [title, desc, address, user]
    ...
    customButtons: {
      list: {
        ...
        click() {
          ...
          const typeView = calendarApi.view.type
          switch (typeView) {
            case 'timeGridDay': {
