<template>
  <div id="viPhamGiaoThong">
    ...
    <div class="mid-layout">
      ...
      <b-card
        class="card-chart"
        title="Dữ liệu thống kê vi phạm trên địa bàn"
      >
        <b-table
          :items="itemsTable"
          :fields="fieldsTable"
...
export default {
  ...
  data() {
    return {
      ...
      fake_chart: require('@/assets/images/cctv/fake_chart.png'),
      itemsTable: [
        {
          column1: 'Trảng Bom',
          column2: 'Trảng Bom',
      ...
      bodyChart: {
        ...
        colors: ['#49c185', '#19baba', '#ca71ce', '#1981be', '#f3543b', '#95a619', '#c63842'],
        xAxis: {
          categories: [
            '02/05/2021',
            '03/05/2021',
